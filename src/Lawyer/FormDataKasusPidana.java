 ...
 * @author Me
 */
public class FormDataKasusPidana extends javax.swing.JFrame {
    ...
    public FormDataKasusPidana() {
      ...
      private void id_data(){
        ...
        ResultSet rs = stat.executeQuery("select * from data_kasus_pidana order by ID_Klien desc");
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        lb1MovingText.setText("                                                                                                                                    Form Data Kasus Pidana ");
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_kasus_pidana VALUES ('"+txt_id_klien.getText()+"','"+txt_nama_klien.getText()+"','"+txt_nama_kasus.getText()+"','"+tanggal+"','"+txt_status_kasus.getText()+"')";
    ...
    private void bhalamanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhalamanActionPerformed
        // TODO add your handling code here:
        DataKasusPidana backpage = new DataKasusPidana();
        backpage.show();
        dispose();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_kasus_pidana set Nama_Klien='"+txt_nama_klien.getText()+"', Nama_Kasus='"+txt_nama_kasus.getText()+"', Tanggal_Kasus='"+tanggal+"', Status_Kasus='"+txt_status_kasus.getText()+"'  where ID_Klien='"+txt_id_klien.getText()+"'";
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM data_kasus_pidana WHERE ID_Klien ='"+txt_id_klien.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataKasusPidana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDataKasusPidana().setVisible(true);
            }
        });
    }
