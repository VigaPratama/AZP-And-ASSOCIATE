 ...
 * @author Me
 */
public class FormDataKasusPerdata extends javax.swing.JFrame {
    ...
    public FormDataKasusPerdata() {
      ...
      private void id_data(){
        ...
        ResultSet rs = stat.executeQuery("select * from data_kasus order by ID_Klien desc");
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        lb1MovingText.setText("                                                                                                                                Form Data Kasus Perdata ");
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_kasus VALUES ('"+txt_id_klien.getText()+"','"+txt_nama_klien.getText()+"','"+txt_nama_kasus.getText()+"','"+tanggal+"','"+txt_status_kasus.getText()+"')";
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_kasus set Nama_Klien='"+txt_nama_klien.getText()+"', Nama_Kasus='"+txt_nama_kasus.getText()+"', Tanggal_Kasus='"+tanggal+"', Status_Kasus='"+txt_status_kasus.getText()+"'  where ID_Klien='"+txt_id_klien.getText()+"'";
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM data_kasus WHERE ID_Klien ='"+txt_id_klien.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataKasusPerdata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDataKasusPerdata().setVisible(true);
            }
        });
    }
