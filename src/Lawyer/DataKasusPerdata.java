 ...
 * @author Me
 */
public class DataKasusPerdata extends javax.swing.JInternalFrame {
   
    /**
     * Creates new form DataPesertaPKH
     */
    public DataKasusPerdata() {
        initComponents();
        tampilkan_data();
    ...
    public void tampilkan_data(){
     DefaultTableModel model = new DefaultTableModel();
       ...
       try{
           int no = 1;
           String sql = "Select * From data_kasus";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Kasus Perdata");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FormDataKasusPerdata backpage = new FormDataKasusPerdata();
        backpage.show();
    ...
    private void print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print1ActionPerformed
        // TODO add your handling code here:
        try {
              File namafile = new File("src/report/report_data_kasus_perdata.jasper");
