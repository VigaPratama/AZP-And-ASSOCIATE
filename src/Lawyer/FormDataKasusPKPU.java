 ...
 * @author Me
 */
public class FormDataKasusPKPU extends javax.swing.JFrame {
    ...
    public FormDataKasusPKPU() {
      ...
      private void id_data(){
        ...
        ResultSet rs = stat.executeQuery("select * from data_kasus_pkpu order by ID_Klien desc");
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        lb1MovingText.setText("                                                                                                                                 Form Data Kasus PKPU");
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_kasus_pkpu VALUES ('"+txt_id_klien.getText()+"','"+txt_nama_klien.getText()+"','"+txt_nama_kasus.getText()+"','"+tanggal+"','"+txt_status_kasus.getText()+"')";
    ...
    private void bhalamanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhalamanActionPerformed
        // TODO add your handling code here:
        DataKasusPKPU backpage = new DataKasusPKPU();
        backpage.show();
        dispose();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_kasus_pkpu set Nama_Klien='"+txt_nama_klien.getText()+"', Nama_Kasus='"+txt_nama_kasus.getText()+"', Tanggal_Kasus='"+tanggal+"', Status_Kasus='"+txt_status_kasus.getText()+"'  where ID_Klien='"+txt_id_klien.getText()+"'";
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM data_kasus_pkpu WHERE ID_Klien ='"+txt_id_klien.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataKasusPKPU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDataKasusPKPU().setVisible(true);
            }
        });
    }
