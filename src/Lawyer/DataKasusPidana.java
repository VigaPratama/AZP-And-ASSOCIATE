 ...
 * @author Me
 */
public class DataKasusPidana extends javax.swing.JInternalFrame {
   
    /**
     * Creates new form DataPesertaPKH
     */
    public DataKasusPidana() {
        initComponents();
        tampilkan_data();
    ...
    public void tampilkan_data(){
     DefaultTableModel model = new DefaultTableModel();
       ...
       try{
           int no = 1;
           String sql = "Select * From data_kasus_pidana";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Kasus Pidana");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        FormDataKasusPidana backpage = new FormDataKasusPidana();
        backpage.show();
    ...
    private void print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print1ActionPerformed
        // TODO add your handling code here:
         try {
              File namafile = new File("src/report/report_data_kasus_pidana.jasper");
